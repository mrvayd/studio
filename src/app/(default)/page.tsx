    ...
    <div className="space-y-16">
      ...
      <section className="relative text-center py-20 md:py-28 bg-gradient-to-br from-primary/5 via-background to-background rounded-xl overflow-hidden shadow-2xl">
        ...
        <div className="relative z-10 container mx-auto px-4">
          ...
          <h1
            className="font-nothing text-6xl font-bold tracking-tight sm:text-7xl md:text-8xl text-transparent bg-clip-text bg-gradient-to-r from-primary to-accent"
          >
            Allied Electronics
          </h1>
